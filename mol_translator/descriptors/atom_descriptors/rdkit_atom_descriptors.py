...
def get_rd_atom_descriptors(rdmol):
    ...
    atom_props['degree'] = degree
    #atom_props['total_valency'] = total_valency
    #atom_props['bitvector'] = bitvector
    atom_props['is_InRing'] = InRing
    atom_props['isAromatic'] = IsAromatic
